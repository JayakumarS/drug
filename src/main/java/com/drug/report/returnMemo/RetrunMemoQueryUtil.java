...
public class RetrunMemoQueryUtil {
	...
	public static final String getMemoDetails = "select return_memo_no as returnMemo,ndcupc_code as ndcupcCode,pakage_or_unit as pakageUnit,quantity as quantity, price as price, exp_date as expDate, reason as reason, lot_no as lotNo from return_memo_items";
