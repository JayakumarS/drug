...
public class ReturnMemoItemsQueryUtil {
	...
	public static final String DELETE_RETURNMEMOITEMS = "delete from return_memo_items where return_memo_no = ?";
	public static final String SELECT_DEBITMEMO = "SELECT return_memo_no as returnMemoNo, ndcupc_code as ndcupcCode, pakage_or_unit as pakageOrUnit, quantity as quantity, price as price, exp_date as expDate, reason as reason, lot_no as lotNo FROM public.return_memo_items where return_memo_no = ?";
