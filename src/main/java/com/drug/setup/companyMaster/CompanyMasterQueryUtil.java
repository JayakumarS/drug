...
//    cppOption,cppServiceRatePer,cppCiiShipping,cppNoOfChecks, 'A'
	public static final String GETCOMPANY_LIST = "SELECT company_code as companyCode,company_name as companyName,mail_id as companyEmailID,state as companyState,city as companyCity,dea_exp_date as defExpirationDate FROM company order by company_code desc";
