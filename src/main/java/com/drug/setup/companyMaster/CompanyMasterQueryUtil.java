...
public class CompanyMasterQueryUtil {
	...
	public static final String INSERT_COMPANY_MASTER = "SELECT  sp_add_company(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
//    cppOption,cppServiceRatePer,cppCiiShipping,cppNoOfChecks, 'A'
	public static final String GETCOMPANY_LIST = "SELECT company_code as companyCode,company_name as companyName,dba_name as companyDba,zip_code as companyPincode,phone_no as companyPhone,state as companyState,city as companyCity,dea_exp_date as defExpirationDate FROM company order by company_code desc";
	...
	public static final String UPDATE_COMPANY_MASTER = "SELECT sp_update_company(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
