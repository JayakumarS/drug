...
public class CommonServicesQueryUtil {
	...
	public static final String GETUSERDETAILS = "SELECT email_id as emailId,company_code as companyCode,photo_url as imgUrl from user_details where emp_id = ? limit 1; ";
